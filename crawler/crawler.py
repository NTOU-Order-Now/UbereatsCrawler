...
def run(playwright: Playwright) -> None:
    ...
    for i in range(count):
        ...
        description_xpath = '/html/body/div[1]/div[1]/div[1]/div[2]/main/div[2]/div/div/div[1]/div[2]'
        description = page.locator(f'xpath={description_xpath}')
        description = description.text_content() if description.count() > 0 else ''
        
        address_xpath = '/html/body/div[1]/div[1]/div[1]/div[2]/main/div[2]/div/div/div[3]/div/section/ul/button[1]/div[2]/div[1]/p[1]'
        address = page.locator(f'xpath={address_xpath}')
        address = address.text_content() if address.count() > 0 else ''
        
        picture_xpath = '/html/body/div[1]/div[1]/div[1]/div[2]/main/div[1]/div/div[1]/img'
        picture = page.locator(f'xpath={picture_xpath}')
        picture = picture.get_attribute('src') if picture.count() > 0 else ''
